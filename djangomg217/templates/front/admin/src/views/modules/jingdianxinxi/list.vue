  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
		...
		<el-form-item class="select" label="景点等级" prop="jingdiandengji">
		  <el-select  @change="jingdiandengjiChange" clearable v-model="searchForm.jingdiandengji" placeholder="请选择景点等级">
		    <el-option
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign" 
               :header-align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('jingdianxinxi','门票') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="menpiaodingdanCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'门票':'' }}</el-button>
                <el-button v-if="isAuth('jingdianxinxi','门票') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="menpiaodingdanCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'门票':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('jingdianxinxi','门票') && contents.tableBtnIcon == 0" type="success" size="mini" @click="menpiaodingdanCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'门票':'' }}</el-button>
    ...
    getDataList() {
      ...
      let params = {
        ...
        sort: 'id',
          ...
          if(this.searchForm.jingdiandengji!='' && this.searchForm.jingdiandengji!=undefined){
            params['jingdiandengji'] = this.searchForm.jingdiandengji
          }
      this.$http({
